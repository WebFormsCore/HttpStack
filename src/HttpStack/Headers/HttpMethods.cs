...
public static class HttpMethods
{
    ...
    {
        _ when IsGet(method) => Get,
        _ when IsPost(method) => Post,
        _ when IsPut(method) => Put,
        _ when IsDelete(method) => Delete,
        _ when IsOptions(method) => Options,
        _ when IsHead(method) => Head,
        _ when IsPatch(method) => Patch,
        _ when IsTrace(method) => Trace,
        _ when IsConnect(method) => Connect,
        _ => method
    };
