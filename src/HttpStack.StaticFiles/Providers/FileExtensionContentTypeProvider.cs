...
public sealed class FileExtensionContentTypeProvider : IContentTypeProvider
{
    public static readonly IContentTypeProvider Default = new FileExtensionContentTypeProvider();
